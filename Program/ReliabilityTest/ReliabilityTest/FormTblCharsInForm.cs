...
{
    public partial class FormTblCharsInForm : Form
    {
        public FormTblCharsInForm()
        {
        ...
        private void FormTblCharsInForm_Load(object sender, EventArgs e)
        {
        ...
        private void SaveButtonClick(object sender, EventArgs e)
        {
            try
            {
                DataSetCharsInForm changes = (DataSetCharsInForm)dataSetCharsInForm.GetChanges();
                if (changes == null)
                    return;
                // check for errors
                DataTable dt = changes.tblCharsInForm.GetChanges();
                ...
                int numRows = tblCharsInFormTableAdapter.Update(changes);
                MessageBox.Show("Updated " + numRows + " rows", "Success");
                dataSetCharsInForm.AcceptChanges();
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error: " + ex.Message, "Erros",
                MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataSetCharsInForm.RejectChanges();
            }
        }
    }
}
